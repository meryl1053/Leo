...
# Replace the language setting in the HTML code with the input language from environment variables
...
def QueryModifier(Query):
    ...
    question_words = ["what", "who", "where", "when", "why", "how", "which", "whose", "whom", "can you", "what's", "where's", "how's", "can you"]
...
# Function to translate a text to English using mtranslate library
